...
export const bio: Bio = {
    ...
    tagline: "I build accessible, inclusive products and digital experiences for the web.",
    heroText: "I'm a software engineer specializing in building (and occasionally designing) exceptional digital experiences. Currently, I'm focused on building accessible, human-centered products.",
...
Fast-forward to today, and I've had the privilege of writing comprehensive articles on React optimizations, TypeScript, and architectural patterns. My main focus these days is building accessible, inclusive products and digital experiences for a variety of clients.
...
export const experiences: Experiences = [
    {
        ...
        description: ["Responsible for leading cross-functional engineering teams to deliver the Field Manager product.",
    ...
    {
        company: "Thinkproject GmbH",
        role: "Senior Frontend Developer",
        date: "2022 - August 2025",
        description: [
...
export const projects: Projects = [
    {
        ...
        description: "The application quickly finds and displays the current weather of your area. Search by your area/city/country/pincode and you would get the weather details in a single click.",
    ...
    },
    {
        ...
        description: "An application that encodes/decodes URL/text to ensure security and reliability during data transmission.",
...
export const publications: Publications = [
    {
        title: "Advanced React Optimization: Fine-Tuning Re-renders with Memoization",
        publisher: "Stackademic",
        date: "Sep 11, 2024",
        url: "https://medium.com/@shaangontia/re-render-46db65929abb",
        description: "A deep dive into React's reconciliation process and how to effectively use React.memo and useMemo to prevent unnecessary re-renders in large scale applications."
    },
    {
        ...
        description: "Exploring how Zod can be used for runtime validation to ensure TypeScript types match runtime data, eliminating unexpected errors."
    },
    {
        ...
        description: "Setting up a lightning-fast development environment using Vite, explaining why it's faster than Webpack and how to configure it for React projects."
    },
    {
        ...
        description: "A practical guide to implementing micro-frontends architecture using React, discussing the benefits and common pitfalls."
    }
];
